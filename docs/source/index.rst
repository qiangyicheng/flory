...
With given interaction matrix :math:`\chi_{ij}`, module :mod:`~flory.mcmp` simply finds the coexisting states of a given point in the phase diagram, namely a given average volume fractions of all components across the system :math:`\bar{\phi}_i`.
For example:
