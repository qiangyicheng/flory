...
class ConstraintBaseCompiled(object):
    ...
    def field(self) -> np.ndarray:
        r"""The field for features generated by the constraint.
        ...
        with the size of :math:`N_\mathrm{f} \times M`. Note that this property should be
    ...
    def prepare(self, phis_feat: np.ndarray, masks: np.ndarray) -> None:
        ...
        of :attr:`field` and :attr:`volume_derivative`.


        Args:
            phis_feat:
                Constant. The 2D array with the size of :math:`N_\\mathrm{f} \\times M`,
                containing the volume fractions of features :math:`\phi_s^{(m)}`.
            masks:
...
class ConstraintBase:
    ...
    example, the volume conservation is a global constraint.
    """
