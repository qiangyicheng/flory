...
class EntropyBase:
    def __init__(self, num_comp: int):
        r"""Base class for a general entropy of mixture.
    ...
    def _compiled_impl(self, **kwargs) -> object:
        """returns entropy instance containing necessary member functions for iteration."""
    ...
    def compiled(self, **kwargs_full) -> object:
        """Create the entropy instance containing necessary member functions for iteration
        This function requires the implementation of :meth:`_entropy_impl`. The
        entropy instance is a compiled class, which must implement following compiled
        functions:
